...
PROD_CFG = os.path.join(_ROOT, "extra", "configs", "historical", "v3_multilevel_ckpt.yaml")
SMOKE_CFG = os.path.join(_ROOT, "extra", "configs", "historical", "smoke_test_v3.yaml")
...
def t_no_v2_in_production_path():
    ...
    for rel, pat in [("cloud/scripts/run_training.sh", "${1:-extra/configs/historical/gcp_full.yaml}"),
...
def main():
    ...
    out = os.path.join(_ROOT, "extra", "reports", "validation",
